...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <h1 class="mt-5">Mantenimiento de la tabla Docente</h1>
        <div class="mb-3">
            <label class="form-label">CodDocente</label>
        ...
        <div class="mb-3">
            <asp:GridView runat="server" ID="gvDocente" CssClass="table table-bordered table-striped"></asp:GridView>
        </div>
        <div class="mb-3">
            <asp:Label Text="Mensaje" runat="server" ID="lblMensaje" CssClass="text-info"></asp:Label>
        </div>
    </div>
